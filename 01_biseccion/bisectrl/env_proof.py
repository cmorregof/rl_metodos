"""Entorno de RL para *aprender a demostrar* la convergencia de la bisección.
...
Con esto el agente descubre el orden lógico: hipótesis → definición →
invariante y longitud → monotonía → convergencia → mismo límite → continuidad
→ raíz y cota → ∎.
"""
