"""Entorno de RL para *aprender a demostrar* el teorema del punto fijo.
...
Con esto el agente descubre el orden lógico: hipótesis → función auxiliar →
existencia (Bolzano) → unicidad; definición → contracción del error →
decaimiento geométrico → convergencia y cotas → ∎.
"""
