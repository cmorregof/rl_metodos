"""Entorno de RL para *aprender a demostrar* la convergencia cuadrática de Newton.
...
Taylor con resto de Lagrange → identidad del error → cota cuadrática →
elección de δ → invariante → convergencia y orden 2 → ∎.
"""
