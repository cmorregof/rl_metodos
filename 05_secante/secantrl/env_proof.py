"""Entorno de RL para *aprender a demostrar* la convergencia de orden φ de la secante.
...
Con esto el agente descubre el orden lógico: hipótesis → entorno con f' ≠ 0 →
forma de Newton del interpolante → identidad del error → cota producto →
elección de δ → invariante → convergencia; Fibonacci → orden φ → ∎.
"""
