...
Vuelve a la terminal. Sigues dentro de \codigo{metodos} (míralo en el prompt, o comprueba con \codigo{pwd}). Entra en la carpeta que acabas de mover:
\begin{orden}
cd rl_metodos-main
ls
\end{orden}
...
\begin{nota}[Si cerraste la terminal o estás en otra carpeta]
Escribe la ruta completa desde tu carpeta de usuario. En Windows las carpetas se separan con \codigo{\textbackslash}; en Mac y Linux con \codigo{/}, y una \codigo{\textbackslash} en Mac significa otra cosa (se «come» la letra siguiente):
\begin{orden}
